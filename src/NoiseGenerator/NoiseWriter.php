...
class NoiseWriter
{
     ...
     */
    public static function noiseValueToByte(float $f)
    {
        if ($f <= 0.0) {
            return 0;
        }
     ...
     */
    public static function toImage(Array $noise)
    {
        $width = count($noise);
     ...
     */
    public static function writeImage(Array $noise, string $fileName)
    {
